...
<body>
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="" style="background-color: rgb(3, 152, 172); padding-top: 20px; height: 70px;">
	<center>
	<footer class="main-footer" style="color: white;">
		Develope By<strong> Muhamad Nabil</strong>
	</footer>
	</center>
</div>
        <!-- partial -->
  ...
  <!-- inject:js -->
  <script src="j{{ asset('admin') }}/s/off-canvas.js"></script>
  <script src="{{ asset('admin') }}/js/hoverable-collapse.js"></script>
  <script src="{{ asset('admin') }}/js/template.js"></script>
  <!-- endinject -->
  <!-- Custom js for this page-->
  <script src="{{ asset('admin') }}/s/dashboard.js"></script>
